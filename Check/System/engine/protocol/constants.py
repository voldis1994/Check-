...
class TradeOutcome(StrEnum):
    """Closed-trade outcome for cooldown selection (never invent WIN)."""
...
REASON_CODE_DESCRIPTIONS: Final[dict[str, str]] = {
    ...
    REASON_NEWS_DATA_UNAVAILABLE: 'News calendar data is unavailable; news risk is not assumed low',
}
