...
def load_dashboard_snapshot(config: SystemConfig, paths: SystemPaths, *, timestamp_utc: str | None=None) -> DashboardSnapshot:
    ...
    return DashboardSnapshot(generated_at_utc=timestamp_utc or now_utc(), instances=views, monitoring_lines=read_monitoring_log_lines(paths))
