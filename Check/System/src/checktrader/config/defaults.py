...
def default_system_dict() -> dict[str, Any]:
    return {
        "version": "2.0.0",
        "runtime": {
            "mode": "live",
        ...
        "trade_management": {
            ...
            "high_lock": {"enabled": True, "activation_peak_profit_money": 1.0, "lock_ratio": 0.60},
            "exit_pressure": {
                "enabled": True,
        ...
        "paths": {"root": ".", "bridge": "runtime/bridge", "state": "runtime/state", "logs": "runtime/logs"},
    }
