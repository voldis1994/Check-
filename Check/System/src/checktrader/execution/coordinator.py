...
class ExecutionCoordinator:
    def __init__(self, config: SystemConfig, bridge_dir: Path | None = None) -> None:
        self.config = config
    ...
    def execute(self, command: Command, positions: list[Position]) -> tuple[Acknowledgement, list[Position]]:
        ...
        return Acknowledgement(command.command_id, True, ReasonCode.EXECUTION_COMMAND_WRITTEN), positions
