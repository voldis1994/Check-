...
def test_build_order_command_from_decision_and_risk_engines() -> None:
    ...
    risk_engine_result = run_risk_engine(decision_result=decision_result, risk_config=RiskConfig(max_open_positions_per_instance=1, max_daily_loss_percent=2.0, max_drawdown_percent=10.0, reward_ratio=2.0, max_risk_per_trade_percent=1.0, max_stop_loss_pips=100.0, volume_step=0.01), instance_state=instance_state, status=StatusRecord(schema_version='1.0.0', timestamp_utc='2026-07-07T06:00:00.000Z', account_id='12345', connected=True, trade_allowed=True, balance=10000.0, equity=10000.0, margin_free=9000.0, ea_version='1.0.0'), trade_params=RiskEngineTradeParams(max_risk_per_trade_percent=1.0, volume_step=0.01, max_stop_loss_pips=100.0), swing_low=1.099, swing_high=1.104)
