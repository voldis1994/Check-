...
def test_system_universe_public_functions_are_defined(universe_source: str) -> None:
    expected = {'SYSTEM_IsUniverseForbiddenField', 'SYSTEM_BuildUniverseFilePath', 'SYSTEM_DetectTradingSession', 'SYSTEM_DetectMarketRegime', 'SYSTEM_BuildUniverseJson', 'SYSTEM_BuildUniverseJsonFromContext', 'SYSTEM_ExportUniverse', 'SYSTEM_UniversePerformsAnalysis'}
...
def test_system_build_universe_file_path_uses_account_universe_filename() -> None:
    path = status_reference.build_universe_file_path('C:\\Check\\System', '12345')
    assert path == 'C:\\Check\\System\\data\\clients\\12345\\universe.json'
