...
SUPPORTED_ACK_STATUSES = {AckStatus.SUCCESS.value, AckStatus.FAILED.value, AckStatus.REJECTED.value}
DEFAULT_SLIPPAGE = 3
...
def execute_control_command(command: control_reference.ControlCommandData, context: OrderExecutionContext) -> AckResult:
