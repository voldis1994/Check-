...
def test_error_journal_entry_with_all_required_fields() -> None:
    entry = ErrorJournalEntry(error_id='err-1', timestamp_utc='2026-07-07T06:00:00.000Z', account_id='12345', symbol='EURUSD', magic=100001, module='validator.market', error_type='VALIDATION', message='market csv invalid', context={'row': 2})
    line = entry.to_dict()
...
def test_error_journal_is_append_only(tmp_path) -> None:
    ...
    first = ErrorJournalEntry(error_id='err-1', timestamp_utc='2026-07-07T06:00:00.000Z', account_id='12345', symbol='EURUSD', magic=100001, module='module.a', error_type='VALIDATION', message='first error')
    second = ErrorJournalEntry(error_id='err-2', timestamp_utc='2026-07-07T06:01:00.000Z', account_id='12345', symbol='EURUSD', magic=100001, module='module.b', error_type='PROTOCOL', message='second error')
...
def test_error_journal_is_isolated_by_instance(tmp_path) -> None:
    ...
    log_error(paths, instance_a, module='module.a', error_type='VALIDATION', message='error A')
    log_error(paths, instance_b, module='module.b', error_type='PROTOCOL', message='error B')
...
def test_error_journal_has_no_silent_exception(tmp_path) -> None:
    ...
    with pytest.raises(Exception):
        log_error(paths, instance, module='module.invalid', error_type='NOT_A_VALID_TYPE', message='this must fail loudly')
