...
def _universe(regime: str, news_active: bool) -> UniverseRecord:
    return UniverseRecord(schema_version='1.0.0', timestamp_utc='2026-07-07T06:00:00.000Z', session='LONDON', market_regime=regime, news_window_active=news_active)
...
def test_analysis_context_round_trip_serialization() -> None:
    context = AnalysisContext(session='LONDON', regime='trending', news_active=False, context_quality=0.9, trade_environment='FAVORABLE', spread_filter_passed=False)
