...
def test_behavior_object_has_consistent_structure() -> None:
    result = analyze_behavior((_bar(0, 1.1, 1.102, 1.099, 1.1015), _bar(1, 1.1015, 1.103, 1.1005, 1.1025)))
...
def test_behavior_analysis_is_independent_from_decision_logic() -> None:
    result = analyze_behavior((_bar(0, 1.1, 1.101, 1.099, 1.1001), _bar(1, 1.1001, 1.1025, 1.0985, 1.1)))
