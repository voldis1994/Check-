...
from engine.decision.buy import BuyCandidate, build_buy_component_scores, calculate_buy_candidate, calculate_buy_score
...
def test_valid_buy_candidate_contains_all_fields() -> None:
    ...
    candidate = calculate_buy_candidate(analysis=_analysis_with_spread_filter(analysis, spread_filter), market_bars=bars, spread_filter=spread_filter, volatility_filter=volatility_filter, news_filter=news_filter, instance_state=_instance_state(), weights=_weights(), stop_loss_buffer=0.0002, reward_ratio=2.0)
