...
def test_reason_codes_exist_and_classified() -> None:
    expected_wait = {REASON_BOTH_DIRECTIONS_INVALID, REASON_EQUAL_SCORES, REASON_EXECUTION_NOT_POSSIBLE}
