...
def test_status_validator_connected_false_is_valid_but_not_tradeable() -> None:
    payload = {'schema_version': '1.0.0', 'timestamp_utc': '2026-07-07T06:00:00.000Z', 'account_id': '12345', 'connected': False, 'trade_allowed': True, 'balance': 10000.0, 'equity': 10020.5, 'margin_free': 9800.0, 'ea_version': '1.0.0'}
...
def test_status_validator_missing_balance_is_invalid() -> None:
    payload = {'schema_version': '1.0.0', 'timestamp_utc': '2026-07-07T06:00:00.000Z', 'account_id': '12345', 'connected': True, 'trade_allowed': True, 'equity': 10020.5, 'margin_free': 9800.0, 'ea_version': '1.0.0'}
    result = validate_status_json(json.dumps(payload))
...
def test_status_validator_nan_values_are_invalid() -> None:
    payload = {'schema_version': '1.0.0', 'timestamp_utc': '2026-07-07T06:00:00.000Z', 'account_id': '12345', 'connected': True, 'trade_allowed': True, 'balance': float('nan'), 'equity': float('nan'), 'margin_free': 9800.0, 'ea_version': '1.0.0'}
    result = validate_status_json(json.dumps(payload))
    assert not result.is_valid
