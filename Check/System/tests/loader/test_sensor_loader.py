...
def test_build_sensor_file_path() -> None:
    ...
    instance = Instance(account_id='12345', symbol='EURUSD', magic=100001)
    assert_path_suffix(build_sensor_file_path(paths, instance), 'data/clients/12345/sensor_EURUSD_100001.csv')
...
def test_load_sensor_data_uses_cache_for_unchanged_file(tmp_path: Path, monkeypatch: pytest.MonkeyPatch) -> None:
