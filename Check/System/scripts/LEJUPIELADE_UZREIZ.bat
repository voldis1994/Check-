...
set "SCRIPT_URL=https://raw.githubusercontent.com/voldis1994/Check-/main/Check/System/scripts/install_windows.ps1"
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%SCRIPT_FILE%" -InstallPath "C:\Check\System" -SkipTests
...
echo  ============================================================
echo   GATAVS! Projekts: C:\Check\System
echo  ============================================================
echo.
echo   Palaid live:  C:\Check\System\PALAID.bat
echo.
goto :end
